...
var addTwoNumbers = function(l1, l2) {
    ...
    // let PreviousNode = new addTwoNumbers();  //initialize it to an empty node
    // let headNode = PreviousNode;
    //step 1: I want to traverse the link list using a while loop
    while(l1 || l2 || carry){ //step 2: traverse both link list to the very end, the loop needs to keep running while l1 or l2 is not null
        ...
        let digit = sum % 10;
        console.log(digit);
        // //step 9: create a li3nked list to return
...
console.log(addTwoNumbers([9,9], [1,6]))